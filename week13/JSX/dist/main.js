...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation.js */ \"./animation.js\");\n //import {ease} from \"./ease.js\"\n\nvar timeline = new _animation_js__WEBPACK_IMPORTED_MODULE_0__[\"Timeline\"]();\ntimeline.start();\ntimeline.add(new _animation_js__WEBPACK_IMPORTED_MODULE_0__[\"Animation\"](document.querySelector(\"#el\").style, \"transform\", 0, 100, 1000, 0, null, function (v) {\n  return \"translateX(\".concat(v, \"px)\");\n})); // tl.add(new Animation(document.getElementById(\"ani3\").style, \"transform\", 0, 500, 5000, 0, null, v => `translateX(${v}px)`));\n// document.getElementById(\"ani2\").style.transition = \"transform 5s ease\";\n// document.getElementById(\"ani2\").style.transform = `translateX(500px)`;\n// document.getElementById(\"pause_btn\").addEventListener(\"click\", () => timeline.pause());\n// document.getElementById(\"resume_btn\").addEventListener(\"click\", () => timeline.resume());\n\n//# sourceURL=webpack:///./animation-demo.js?");
